        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                "3. If AGENTS.md or other instruction files already exist: do not overwrite; call yabgu_conflicts once and report clashes before proposing new files.",
                "4. Show results to me: (a) best practices that apply right now, (b) session facts only, (c) each proposed file and why — do not offer Copilot/Gemini/Claude unless those hosts were requested. Do not write yet. Surface plan warnings.",
                "5. After I approve, call yabgu_apply (host UI may confirm; otherwise use confirmed=true).",
                "6. Call yabgu_measure again and summarize before/after (score, missing files, tone hits).",
